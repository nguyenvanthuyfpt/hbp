...
<script>
	function readArticle() {
		...
		/* var title = "thu%20nhập%20bình%20quân%20đầu%20người%20ước%20đạt%2034%20triệu%20đồng";	
		b.src = "https://support.lsdsoftware.com/read-aloud/speak/vi/Whisper?q=" + title; 
		b.play(); */	
		
		var lead = $("#leadDetail").text();
		// var lead = "Nằm%20tại%20trung%20tâm%20thị%20trấn%20Mai%20Châu%20trong%20thung%20lũng%20thơ%20mộng";
		b.src = "https://support.lsdsoftware.com/read-aloud/speak/vi/Whisper?q=" + lead;
		b.crossOrigin = 'anonymous';
	    b.play();
		
		/*
		var content = $("#contentDetail").text();
	    var d = unescape(content),
	        a = 0;
	    var c = function() {
	        if (a < d.length) {
